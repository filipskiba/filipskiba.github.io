...
$(function () {
  ...
  //  var endpoint = 'https://spring-security-jwt-fs.herokuapp.com'
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                if (jqXHR.status === 401) {
                    $('#loginErrorModal')
                        ...
                        .find(".modal-body")
                        .empty()
                        .html("<p>Spring exception:<br>" + jqXHR.responseJSON.message + "</p>");
                } else {
    ...
    function showUserInformation() {
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                var $authorities = $("<div>").text("Dostęp:");
    ...
    function showTokenInformation() {
        ...
        $loggedInBody.append($("<h4 style=\"margin-top: 30px\">").text("Dane o tokenie: "));
